...
const FeaturesComponent = () => {
    return <>
        ...
        <div className="container py-16  flex gap-10  justify-between items-center">
            ...
            <div className=" shadow-lg rounded-sm px-3 py-6 flex  items-center gap-5">
                <span className="w-12 h12 object-cover text-secondary">
                ...
                <div>
                    <h4 className="font-medium capitalize text-lg">Return & Refung</h4>
            ...
            <div className=" shadow-lg rounded-sm px-3 py-6 flex items-center gap-5">
                ...
                <div>
                    <h4 className="font-medium capitalize text-lg">Member Discount</h4>
                    <p className="text-gray-500 text-sm">Onevery order over $140.00</p>
                </div>
            </div>
            ...
            <div className=" shadow-lg rounded-sm px-3 py-6 flex  items-center gap-5">
                ...
                <div>
                    <h4 className="font-medium capitalize text-lg">Support 24/7</h4>
